...
public class MyQueueTest {
	...
	public void testDequeueStudent() {
		...
		try {
			assertEquals(mun, doubleQ.dequeue());
			assertEquals(ski, doubleQ.dequeue());
			assertEquals(diep, doubleQ.dequeue());
	...
	public void testEnqueueStudent() {
		...
		try {
			...
			assertEquals(true, doubleQ.enqueue(du));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(ma));
			assertEquals(5, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(daj));
